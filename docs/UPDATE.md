...
SHA256. Mac packages and self-updates skip root controller reinstall by default;
set `PROXY_GATEWAY_SKIP_ROOTCTL_INSTALL=0` when a release intentionally changes
the root controller and can prompt for `sudo`.
